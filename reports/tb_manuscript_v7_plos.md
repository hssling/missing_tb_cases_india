...
## Abstract
**Background and Objectives:** India has expanded TB case finding and digital surveillance, yet a sizable gap remains between incident tuberculosis (TB) and cases reported to the National Tuberculosis Elimination Programme (NTEP). Quantifying these "missed" cases at state level and clarifying the analytic framework are essential for aligning with the WHO End TB Strategy.  
